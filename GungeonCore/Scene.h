...
struct RaycastHit                               // Dados do raycast
{
    bool didHit;                                // raio colidiu com algo
    Point hitPoint;                             // exato ponto de colisão
    float distance = 0.0f;                      // distancia entra inicio do raio e ponto de colisão
    Object* objectHit = nullptr;                // objeto que colidiu com o raio
};
...
public:
    ...
    bool Raycast(Point origin, Vector direction, float maxDistance, RaycastHit& hitInfo, uint layerMask, Object* objectToIgnore); // envia raio para testar colisão
};
