...
{ 
    ...
    ENEMYFIRE, DROPPEDITEM, HITBOX, GUN, VAZIO, JARSHRAP, JAR, EXPLOSION, WALLHIT, HAND
};

enum Soundtrack
{
    START_SCREEN, THEME_SONG, GAME_OVER_SONG, VICTORY_SONG, BOSS_FIGHT, EXPLORATION_SONG, MENU_HOVER, MENU_CLICK, ZOMBIE_SCREAM,
    BAT_NOISE_1, BAT_NOISE_2, BAT_NOISE_3, BAT_NOISE_4, BAT_NOISE_5, BAT_NOISE_6, BAT_NOISE_7, BAT_NOISE_8, BAT_NOISE_9, BAT_NOISE_10,
    EMPTY_GUN, WEAPON_EQUIP,
