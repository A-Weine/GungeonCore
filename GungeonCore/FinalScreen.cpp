...
void FinalScreen::Update()
{
    ...
    if (window->KeyPress(VK_SPACE)) {
        GungeonCore::player->initialX = 96;
        GungeonCore::player->initialY = 760;
...
void FinalScreen::Draw()
{
    ...
    font->Draw(window->CenterX() - 120.0f, window->CenterY() + 130.0f, "RESTART", white, Layer::FRONT, 0.2f);
}

void FinalScreen::Finalize()
{
