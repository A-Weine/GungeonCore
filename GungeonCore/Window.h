...
//#include "Game.h"     // inclui o cabeçalho do Game
#include <string>       // include a classe string
#include "Geometry.h"  // inclui a classe Point para coordenadas
using std::string;      // permite usar o tipo string sem std::

class Game; // <-- ADICIONE ESTA LINHA (A "PROMESSA" / FORWARD DECLARATION)
...
public:
    ...
    Point ScreenToWorld(Game* level);
