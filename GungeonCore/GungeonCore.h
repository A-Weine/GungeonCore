...
enum Ids 
{ 
    PLATFORM, PLAYER, SHADOW, RANDOMMOVEMENTVILLAIN, CHASEVILLAIN , RUNAWAYVILLAIN, FIRE, 
    ENEMYFIRE, DROPPEDITEM, HITBOX, GUN, VAZIO, JARSHRAP, JAR, EXPLOSION
};

enum Soundtrack
{
    START_SCREEN, THEME_SONG, GAME_OVER_SONG, VICTORY_SONG, BOSS_FIGHT, EXPLORATION_SONG, MENU_HOVER, MENU_CLICK, START, THEME,
    RUNNING, BOSS_DASH, GRAB_ITEM, MAGNUM_RELOAD, SHORTRANGE_ATTACK, FIRE_HIT_VILLAIN, MAGNUM_FIRE, TAKE_DAMAGE, MENU_SELECT,
    SHOTGUN_RELOAD, SHOTGUN_FIRE, LONGRANGE_ATTACK, VILLAIN_DIES, BOSS_DYING, BOSS_SPEECH, GRAB_KEY, FIRE_HIT_STONE, SONG_LEVEL1,
    SONG_LEVEL2, LOOP_THEME
};
