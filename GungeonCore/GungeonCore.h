...
enum Ids 
{ 
    PLAYER, PLATFORM, SHADOW, RANDOMMOVEMENTVILLAIN, CHASEVILLAIN , RUNAWAYVILLAIN, FIRE, ENEMYFIRE, DROPPEDITEM, DOOR, HITBOX, BONEPROJECTILE,
};

enum Soundtrack
{
    START, THEME, RUNNING, BOSS_DASH, GRAB_ITEM, MAGNUM_RELOAD, SHORTRANGE_ATTACK,
